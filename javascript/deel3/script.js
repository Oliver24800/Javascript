...
function instruction9() {
    ...
    var description = "Voeg element en image toe";
    var result = "";
    var txt1 = document.createTextNode("Links");
    var txt2 = document.createTextNode("Rechts");
    ...
    updateContent("Opdracht 9 - Elementen", description, result);
...
function instruction10() {
    var description = "String bewerking";
    var string = "De string waar de bewerkingen op gedaan woorden is: ";
    var naamString = "Mediacollege Amsterdam";

    var result = string + naamString + "<br>";
    result += "De lengte van de string is: " + naamString.length + "<br>";
    naamString = naamString.substr(1)
    result += "De eerste letter is vervangen door een spatie: " + naamString + "<br>";
    result += "De lengte van de string is nog steeds: " + naamString.length + "<br>";
    naamString = naamString.trim();
    result += "Alle spaties aan het begin en eind zijn nu verwijderd: " + naamString + "<br>";
    result += "De lengte van de string is nu: " + naamString.length + "<br>";
    result += "Het aantal woorden is: " + naamString.split(' ').length + "<br>";
    result += "Het eerste woord is: " + naamString.split(' ')[0] + "<br>";
    result += "Het tweede woord is: " + naamString.split(' ')[1];
